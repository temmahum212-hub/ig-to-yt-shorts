...
def get_authenticated_service():
    creds = None
    # GitHub Secrets'tan token veya client bilgilerini doğrudan okuyacak şekilde ayarlıyoruz
    if os.environ.get('YT_CLIENT_ID') and os.environ.get('YT_CLIENT_SECRET'):
        # Eğer doğrudan secret tanımlıysa token nesnesi oluşturalım
